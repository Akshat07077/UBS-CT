    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 md:py-14">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          List your car for rent on {brand.name}. You do <strong className="text-foreground font-semibold">not</strong> need an account. Submissions stay hidden until an admin approves them.
        </p>
      </div>
