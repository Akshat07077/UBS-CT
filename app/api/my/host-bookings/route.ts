...
import { getHostBookings, normalizeLookupPhone } from "@/lib/my-account";
import { isValidLookupPhone } from "@/lib/phone-match";

/** Bookings made by renters on cars you listed. */
export async function GET(req: NextRequest) {
  try {
    ...
    const bookings = await getHostBookings(user, phone);
