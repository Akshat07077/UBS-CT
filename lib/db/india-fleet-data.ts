...
export const INDIA_FLEET = [
  ...
  },
  {
    ...
    seats: 2,
    location: LOC,
    description: "Royal Enfield Classic 350 — ideal for city rides and short highway trips around Indore.",
    ...
    listing: listing({
      ...
      segment: "budget",
      promoTag: null,
      availabilityNote: "Bike rental · Indore",
      pricePerDayMax: 800,
      driverPerDayMin: 0,
      driverPerDayMax: 0,
      securityDepositMin: 1000,
      securityDepositMax: 3000,
      tripLocalInr: 500,
      tripLocalNote: "Local day ride",
    }),
  },
  {
    vehicleType: "scooty" as const,
    brand: "Honda",
    model: "Activa",
    year: 2023,
    pricePerDay: "400",
    ...
    seats: 2,
    location: LOC,
    description: "Honda Activa — easy automatic scooty for daily errands and city commutes.",
    imageUrl: "https://images.unsplash.com/photo-1609630875171-b132337ffead?auto=format&fit=crop&w=1200&q=80",
    available: true,
    listing: listing({
      supplierName: SUPPLIER,
      segment: "budget",
      promoTag: null,
      availabilityNote: "Scooty rental · Indore",
      pricePerDayMax: 550,
      driverPerDayMin: 0,
      driverPerDayMax: 0,
      securityDepositMin: 500,
      securityDepositMax: 2000,
      tripLocalInr: 350,
      tripLocalNote: "Local day ride",
    }),
  },
